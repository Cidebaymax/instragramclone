...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_btn = findViewById(R.id.btn_Loginit);
        txt_registrasi = findViewById(R.id.tex_Registrasiit);
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(str_email) || TextUtils.isEmpty(str_password)){
                    Toast.makeText(LoginActivity.this, "all failed are requered!" , Toast.LENGTH_SHORT).show();
                            ...
                            .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()){
                                        ...
                                        progressDialog.dismiss();
                                        Toast.makeText(LoginActivity.this, "authencion Failed", Toast.LENGTH_SHORT).show();
